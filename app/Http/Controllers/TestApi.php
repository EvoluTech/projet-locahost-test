...
public function search($id_user,$id_objet)
    {
       $search = DB::select(
        ...
        FROM users u, bienspostuler bp, biens b
        WHERE u.id_user=? and b.id_objet=?',[$id_user,$id_objet]);
    ...
    public function searchpub(Request $request,$id_user)
    {
            // Récupérer l'utilisateur connecté
            $user = Auth::user();
    
            // Récupérer toutes les publications associées à l'utilisateur
            $searchpub = DB::select(
                'SELECT u.pdp as sarytapaka, u.nom_user as nom,
                        bp.photos_1 as sary1, bp.photos_2 as sary2, bp.photos_3 as sary3, bp.adresse_bien as descritionlieu,
                        b.type_objet as typebien,
